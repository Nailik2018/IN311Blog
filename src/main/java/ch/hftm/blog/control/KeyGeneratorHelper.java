...
//
//    @ConfigProperty(name = "session.minutes")
//    int sessionMinutes;
//
...
//        JwtClaimsBuilder builder1 = Jwt.claims().issuer("hftm").groups(role).upn(username).expiresAt((new Date().getTime()/1000) + sessionMinutes*60);
